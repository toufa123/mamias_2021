...
final class CatalogueAdminController extends CRUDController
{
    ...
    public function batchActionworms(ProxyQueryInterface $selectedModelQuery)
    {
        ...
        foreach ($selectedModels as $selectedModel) {
            ...
            if ('204' == $code or '400' == $code) {
                ...
                $this->addFlash('sonata_flash_success', ' <i>' . $S . '</i> with AphiaID : ' . $AphiaID . ' is checked through WoRMS <br>');
            }
        }
    ...
    public function manualAction()
    {
        ...
        foreach ($data3 as $a) {
            ...
            $this->getRequest()->getSession()->getFlashBag()->add('success', "<i>$S</i> with the AphiaID ($Aphia)  is checked through WoRMS <br>");
