...
'use strict';
(function (a) {
    "object" === typeof module && module.exports ? (a["default"] = a, module.exports = a) : "function" === typeof define && define.amd ? define("highcharts/themes/high-contrast-dark", ["highcharts"], function (b) {
        a(b);
        a.Highcharts = b;
        return a
    ...
    function b(a, d, b, e) {
        a.hasOwnProperty(d) || (a[d] = e.apply(null, b))
    }

    a = a ? a._modules : {};
    b(a, "Extensions/Themes/HighContrastDark.js", [a["Core/DefaultOptions.js"]], function (a) {
        var b = a.setOptions, c;
        (function (a) {
            a.options =
                {
                    colors: "#a6f0ff #70d49e #e898a5 #007faa #f9db72 #f45b5b #1e824c #e7934c #dadfe1 #a0618b".split(" "),
                    ...
                    tooltip: {backgroundColor: "rgba(0, 0, 0, 0.85)", style: {color: "#F0F0F3"}},
                    plotOptions: {
                    ...
                    rangeSelector: {
                        buttonTheme: {
                            ...
                            style: {color: "#eee"},
                            states: {
                                hover: {fill: "#707073", stroke: "#000000", style: {color: "#F0F0F3"}},
                                select: {fill: "#303030", stroke: "#101010", style: {color: "#F0F0F3"}}
                            }
                        },
    ...
    b(a, "masters/themes/high-contrast-dark.src.js",
        [a["Core/Globals.js"], a["Extensions/Themes/HighContrastDark.js"]], function (a, b) {
            a.theme = b.options;
            b.apply()
        })
});
