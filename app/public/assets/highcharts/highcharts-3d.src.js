        ...
        (function (Chart3D) {
                ...
                Composition.prototype.get3dFrame = function () {
                    var chart = this.chart,
                        ...
                        faceOrientation = function (vertexes) {
                            ...
                            {x: xp, y: yp, z: zp},
                            {x: xm, y: yp, z: zp}
                        ]), defaultShowBottom = false, defaultShowTop = false, defaultShowLeft = false,
                        defaultShowRight = false, defaultShowFront = false, defaultShowBack = true;
            ...
            function onAfterSetChartSize() {
                ...
                if (chart.chart3d &&
                    ...
                    var inverted = chart.inverted, clipBox = chart.clipBox, margin = chart.margin,
                        x = inverted ? 'y' : 'x', y = inverted ? 'x' : 'y', w = inverted ? 'height' : 'width',
