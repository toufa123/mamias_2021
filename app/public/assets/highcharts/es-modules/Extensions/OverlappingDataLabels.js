...
var addEvent = U.addEvent, fireEvent = U.fireEvent, isArray = U.isArray, isNumber = U.isNumber,
    ...
    var chart = this, len = labels.length, ren = chart.renderer, label, i, j, label1, label2, box1, box2,
        ...
        getAbsoluteBox = function (label) {
            var pos, parent, bBox,
                ...
                padding = label.box ? 0 : (label.padding || 0), lineHeightCorrection = 0, xOffset = 0, boxWidth,
                alignValue;
            if (label &&
