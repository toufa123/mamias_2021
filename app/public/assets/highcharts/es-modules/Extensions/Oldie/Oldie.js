        ...
        color: function (colorOption, elem, prop, wrapper) {
            ...
            if (fillType) {
                var stopColor_1, stopOpacity_1, gradient = (colorOption.linearGradient ||
                    ...
                    opacity2_1, color1_1, color2_1, fillAttr_1 = '', stops = colorOption.stops, firstStop = void 0,
                    lastStop = void 0, colors_1 = [], addFillNode_1 = function () {
                ...
                if (prop === 'fill') {
                    ...
                    if (fillType === 'gradient') {
                        ...
                        var r = gradient.r, sizex_1 = r * 2, sizey_1 = r * 2, cx_1 = gradient.cx, cy_1 = gradient.cy,
                            radialReference_1 = elem.radialReference, bBox_1, applyRadialGradient = function () {
