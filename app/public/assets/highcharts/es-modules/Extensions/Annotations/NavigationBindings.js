...
var bindingsUtils = {
    ...
    updateRectSize: function (event, annotation) {
        var chart = annotation.chart, options = annotation.options.typeOptions,
            ...
            coordsY = chart.navigationBindings.utils.getAssignedAxis(coords.yAxis), width, height;
        if (coordsX && coordsY) {
...
var NavigationBindings = /** @class */ (function () {
    ...
    NavigationBindings.prototype.annotationToFields = function (annotation) {
        var options = annotation.options, editables = NavigationBindings.annotationsEditable,
            ...
            nonEditables = NavigationBindings.annotationsNonEditable[options.langKey] || [], visualOptions = {
