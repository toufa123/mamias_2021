...
var addEvent = U.addEvent, createElement = U.createElement, defined = U.defined, fireEvent = U.fireEvent,
    isArray = U.isArray, isObject = U.isObject, objectEach = U.objectEach, pick = U.pick, stableSort = U.stableSort,
    wrap = U.wrap;
var indexFilter = /\d/g, PREFIX = 'highcharts-', A = 'a', DIV = 'div', INPUT = 'input', LABEL = 'label',
...
H.Popup.prototype = {
    ...
    addInput: function (option, indicatorType, parentDiv, inputAttributes) {
        var optionParamList = option.split('.'), optionName = optionParamList[optionParamList.length - 1],
            lang = this.lang, inputName = PREFIX + indicatorType + '-' + pick(inputAttributes.htmlFor, optionName);
        var input;
    ...
    getFields: function (parentDiv, type) {
        var inputList = Array.prototype.slice.call(parentDiv.querySelectorAll(INPUT)),
        ...
        inputList.forEach(function (input) {
            var param = input.getAttribute(PREFIX + 'data-name'),
    ...
    indicators: {
        ...
        filterSeries: function (series, filter) {
            var popup = this, indicators = popup.indicators, lang = popup.chart && popup.chart.options.lang,
            ...
            objectEach(series, function (series, value) {
                ...
                if (series.params || seriesOptions &&
                    ...
                    var _a = indicators.getNameType(series, value), indicatorFullName = _a.indicatorFullName,
        ...
        addIndicatorList: function (chart, parentDiv, listType, filter) {
            var popup = this, indicators = popup.indicators, lang = popup.lang,
                ...
                addFormFields = this.indicators.addFormFields, series = (isEdit ?
            ...
            filteredSeriesArray.forEach(function (seriesSet) {
                var indicatorFullName = seriesSet.indicatorFullName, indicatorType = seriesSet.indicatorType,
        ...
        addSearchBox: function (chart, parentDiv) {
            var popup = this, lhsCol = parentDiv.querySelectorAll('.' + PREFIX + 'popup-lhs-col')[0],
                options = 'searchIndicators', inputAttributes = {
                    value: '',
                    type: 'text',
