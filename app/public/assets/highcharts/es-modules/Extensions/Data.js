...
var Data = /** @class */ (function () {
    ...
    Data.prototype.parseGoogleSpreadsheet = function () {
        var data = this, options = this.options, googleSpreadsheetKey = options.googleSpreadsheetKey,
            chart = this.chart, refreshRate = Math.max((options.dataRefreshRate || 2) * 1000, 4000);
        /**
        ...
        if (googleSpreadsheetKey) {
            ...
            fetchSheet(function (json) {
                ...
                var rowCount = columns.reduce(function (rowCount, column) {
                    return Math.max(rowCount, column.length);
                }, 0);
