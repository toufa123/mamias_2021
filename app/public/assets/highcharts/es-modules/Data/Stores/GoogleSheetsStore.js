...
var GoogleSheetsStore = /** @class */ (function (_super) {
    ...
    GoogleSheetsStore.prototype.fetchSheet = function (eventDetail) {
        var store = this, _a = store.options, enablePolling = _a.enablePolling, dataRefreshRate = _a.dataRefreshRate,
            googleSpreadsheetKey = _a.googleSpreadsheetKey, worksheet = _a.worksheet, url = [
