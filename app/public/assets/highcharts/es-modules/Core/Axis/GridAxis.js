...
var GridAxis = /** @class */ (function () {
    ...
    GridAxis.onAfterGetTitlePosition = function (e) {
        ...
        if (gridOptions.enabled === true) {
            ...
            var title = axis.axisTitle, axisHeight = axis.height, horiz = axis.horiz, axisLeft = axis.left,
                offset = axis.offset, opposite = axis.opposite, _a = axis.options.title,
                axisTitleOptions = _a === void 0 ? {} : _a, axisTop = axis.top, axisWidth = axis.width;
