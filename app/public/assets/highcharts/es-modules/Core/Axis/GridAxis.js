...
(function (GridAxis) {
    ...
    function onAfterRender() {
        ...
        if (gridOptions.enabled === true) {
            ...
            if (!axis.horiz &&
                ...
                var tickmarkOffset = axis.tickmarkOffset, lastTick = axis.tickPositions[axis.tickPositions.length - 1],
    ...
    function onAfterSetOptions(e) {
        var options = this.options, userOptions = e.userOptions,
    ...
    function onTickAfterGetLabelPosition(e) {
        var tick = this, label = tick.label, axis = tick.axis, reversed = axis.reversed, chart = axis.chart,
            ...
            tickPos = tick.pos - tickmarkOffset, nextTickPos = (isNumber(tickPositions[e.index + 1]) ?
                ...
                (axis.max || 0) + tickmarkOffset), tickSize = axis.tickSize('tick'), tickWidth = tickSize ? tickSize[0] : 0,
