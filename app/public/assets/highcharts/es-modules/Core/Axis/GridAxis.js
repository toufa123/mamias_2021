...
addEvent(Tick, 'afterGetLabelPosition', function (e) {
    var tick = this, label = tick.label, axis = tick.axis, reversed = axis.reversed, chart = axis.chart,
        options = axis.options, gridOptions = options.grid || {}, labelOpts = axis.options.labels,
        align = labelOpts.align,
        // verticalAlign is currently not supported for axis.labels.
        verticalAlign = 'middle', // labelOpts.verticalAlign,
        side = GridAxis.Side[axis.side], tickmarkOffset = e.tickmarkOffset, tickPositions = axis.tickPositions,
        tickPos = tick.pos - tickmarkOffset, nextTickPos = (isNumber(tickPositions[e.index + 1]) ?
        tickPositions[e.index + 1] - tickmarkOffset :
        axis.max + tickmarkOffset), tickSize = axis.tickSize('tick'), tickWidth = tickSize ? tickSize[0] : 0,
        crispCorr = tickSize ? tickSize[1] / 2 : 0, labelHeight, lblMetrics, lines, bottom, top, left, right;
...
var GridAxisAdditions = /** @class */ (function () {
    ...
    GridAxisAdditions.prototype.renderBorder = function (path) {
        var axis = this.axis, renderer = axis.chart.renderer, options = axis.options,
...
var GridAxis = /** @class */ (function () {
    ...
    GridAxis.onAfterGetTitlePosition = function (e) {
        ...
        if (gridOptions.enabled === true) {
            ...
            var axisTitle = axis.axisTitle, axisHeight = axis.height, horiz = axis.horiz, axisLeft = axis.left,
                offset = axis.offset, opposite = axis.opposite, options_1 = axis.options, axisTop = axis.top,
    ...
    GridAxis.onAfterInit = function () {
        var axis = this;
        var chart = axis.chart, _a = axis.options.grid, gridOptions = _a === void 0 ? {} : _a,
    ...
    GridAxis.onAfterRender = function () {
        ...
        if (gridOptions.enabled === true) {
            ...
            if (axis.grid && axis.grid.isOuterAxis() && axis.axisLine) {
                ...
                if (lineWidth) {
                    ...
                    if (!axis.horiz && axis.chart.marginRight) {
                        var upperBorderStartPoint = startPoint, upperBorderEndPoint = ['L', axis.left, startPoint[2]],
                            upperBorderPath = [upperBorderStartPoint, upperBorderEndPoint],
                            lowerBorderEndPoint = ['L', axis.chart.chartWidth - axis.chart.marginRight, axis.toPixels(axis.max + axis.tickmarkOffset)],
                            lowerBorderStartPoint = ['M', endPoint[1], axis.toPixels(axis.max + axis.tickmarkOffset)],
            ...
            if (!axis.horiz &&
                ...
                var max = axis.max, min = axis.min, tickmarkOffset = axis.tickmarkOffset,
                    lastTick = axis.tickPositions[axis.tickPositions.length - 1], firstTick = axis.tickPositions[0];
            ...
            if (this.coll === 'xAxis') {
                ...
                if (
                    ...
                    gridAxisOptions.tickPositioner = function (min, max) {
                        ...
                        if (parentInfo) {
                            var unitIdx = void 0, count = void 0, unitName = void 0, i = void 0,
                                units = gridAxisOptions.units, unitRange = void 0;
    ...
    GridAxis.onAfterTickSize = function (e) {
        ...
        var _a = this, horiz = _a.horiz, maxLabelDimensions = _a.maxLabelDimensions, _b = _a.options.grid,
