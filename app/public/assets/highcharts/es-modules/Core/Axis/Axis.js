...
var addEvent = U.addEvent, arrayMax = U.arrayMax, arrayMin = U.arrayMin, clamp = U.clamp, correctFloat = U.correctFloat,
    defined = U.defined, destroyObjectProperties = U.destroyObjectProperties, erase = U.erase, error = U.error,
    extend = U.extend, fireEvent = U.fireEvent, getMagnitude = U.getMagnitude, isArray = U.isArray,
    isFunction = U.isFunction, isNumber = U.isNumber, isString = U.isString, merge = U.merge,
...
var Axis = /** @class */ (function () {
    ...
    Axis.prototype.defaultLabelFormatter = function () {
        var axis = this.axis, value = isNumber(this.value) ? this.value : NaN, time = axis.chart.time,
            categories = axis.categories, dateTimeLabelFormat = this.dateTimeLabelFormat, lang = defaultOptions.lang,
            numericSymbols = lang.numericSymbols, numSymMagnitude = lang.numericSymbolMagnitude || 1000,
            i = numericSymbols && numericSymbols.length, multi, ret,
        ...
        fireEvent(this, 'getSeriesExtremes', null, function () {
            ...
            axis.series.forEach(function (series) {
                if (series.visible ||
                    ...
                    var seriesOptions = series.options, xData = void 0, threshold = seriesOptions.threshold,
                        seriesDataMin = void 0, seriesDataMax = void 0;
    ...
    Axis.prototype.translate = function (val, backwards, cvsCoord, old, handleLog, pointPlacement) {
        var axis = this.linkedParent || this, // #1417
            sign = 1, cvsOffset = 0, localA = old && axis.old ? axis.old.transA : axis.transA,
            localMin = old && axis.old ? axis.old.min : axis.min, returnValue = 0,
            minPixelPadding = axis.minPixelPadding, doPostTranslate = (axis.isOrdinal ||
    ...
    Axis.prototype.adjustForMinRange = function () {
        var axis = this, options = axis.options, min = axis.min, max = axis.max, log = axis.logarithmic, zoomOffset,
            spaceAvailable, closestDataRange = 0, i, distance, xData, loopLength, minArgs, maxArgs, minRange;
    ...
    Axis.prototype.setTickInterval = function (secondPass) {
        var axis = this, chart = axis.chart, log = axis.logarithmic, options = axis.options, isXAxis = axis.isXAxis,
            isLinked = axis.isLinked, maxPadding = options.maxPadding, minPadding = options.minPadding, length,
            linkedParentExtremes, tickIntervalOption = options.tickInterval, minTickInterval,
    ...
    Axis.prototype.setTickPositions = function () {
        var axis = this, options = this.options, tickPositions, tickPositionsOption = options.tickPositions,
            minorTickIntervalOption = this.getMinorTickInterval(), tickPositioner = options.tickPositioner,
            hasVerticalPanning = this.hasVerticalPanning(), isColorAxis = this.coll === 'colorAxis',
    ...
    Axis.prototype.getTickAmount = function () {
        var axis = this, options = this.options, tickAmount = options.tickAmount,
    ...
    Axis.prototype.adjustTickAmount = function () {
        var axis = this, axisOptions = axis.options, tickInterval = axis.tickInterval,
            ...
            threshold = pick(axis.threshold, axis.softThreshold ? 0 : null), len, i;
    ...
    Axis.prototype.tickSize = function (prefix) {
        var options = this.options, tickLength = options[prefix === 'tick' ? 'tickLength' : 'minorTickLength'],
    ...
    Axis.prototype.unsquish = function () {
        var labelOptions = this.options.labels, horiz = this.horiz, tickInterval = this.tickInterval,
            ...
            bestScore = Number.MAX_VALUE, autoRotation, range = Math.max(this.max - this.min, 0),
    ...
    Axis.prototype.renderUnsquish = function () {
        var chart = this.chart, renderer = chart.renderer, tickPositions = this.tickPositions, ticks = this.ticks,
            ...
            commonWidth, commonTextOverflow, maxLabelLength = 0, label, i, pos;
    ...
    Axis.prototype.drawCrosshair = function (e, point) {
        var path, options = this.crosshair, snap = pick(options && options.snap, true), pos, categorized,
            graphic = this.cross, crossOptions, chart = this.chart;
