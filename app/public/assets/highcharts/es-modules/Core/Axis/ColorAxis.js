...
var ColorAxis = /** @class */ (function (_super) {
    ...
    ColorAxis.prototype.initDataClasses = function (userOptions) {
        var axis = this;
        var chart = axis.chart, dataClasses, colorCounter = 0, colorCount = chart.options.chart.colorCount,
            options = axis.options, len = userOptions.dataClasses.length;
    ...
    ColorAxis.prototype.getSeriesExtremes = function () {
        ...
        var colorValArray, colorKey, colorValIndex, pointArrayMap, calculatedExtremes, cSeries, i = series.length,
            yData, j;
