    ...
    var Composition = /** @class */ (function () {
        ...
        * */
        ...
        Composition.prototype.beforeSetTickPositions = function () {
            var axis = this.axis, ordinal = axis.ordinal, len, ordinalPositions = [], uniqueOrdinalPositions,
                useOrdinal = false, dist, extremes = axis.getExtremes(), min = extremes.min, max = extremes.max,
                minIndex, maxIndex, slope, hasBreaks = axis.isXAxis && !!axis.options.breaks,
                isOrdinal = axis.options.ordinal, overscrollPointsRange = Number.MAX_VALUE,
        ...
        Composition.prototype.getExtendedPositions = function () {
            var ordinal = this, axis = ordinal.axis, axisProto = axis.constructor.prototype, chart = axis.chart,
                grouping = axis.series[0].currentDataGrouping, ordinalIndex = ordinal.index, key = grouping ?
        ...
        Composition.prototype.getGroupIntervalFactor = function (xMin, xMax, series) {
            var ordinal = this, axis = ordinal.axis, i, processedXData = series.processedXData,
                len = processedXData.length, distances = [], median, groupIntervalFactor = ordinal.groupIntervalFactor;
    ...
    function compose(AxisClass, ChartClass, SeriesClass) {
        ...
        AxisClass.prototype.getTimeTicks = function (normalizedInterval, min, max, startOfWeek, positions, closestDistance, findHigherRanks) {
            ...
            if (findHigherRanks && defined(tickPixelIntervalOption)) {
                var length_1 = groupPositions.length, i = length_1, itemToRemove = void 0, translated = void 0,
                    translatedArr = [], lastTranslated = void 0, medianDistance = void 0, distance = void 0,
                    distances = [];
        ...
        axisProto.lin2val = function (val, fromIndex) {
            ...
            if (!ordinalPositions) {
                ...
                var ordinalSlope = ordinal.slope, ordinalOffset = ordinal.offset, i = ordinalPositions.length - 1,
                    linearEquivalentLeft = void 0, linearEquivalentRight = void 0, distance = void 0;
        ...
        addEvent(ChartClass, 'pan', function (e) {
            var chart = this, xAxis = chart.xAxis[0], overscroll = xAxis.options.overscroll,
                chartX = e.originalEvent.chartX, panning = chart.options.chart.panning, runBase = false;
            if (panning &&
                panning.type !== 'y' &&
                xAxis.options.ordinal &&
                xAxis.series.length) {
                var mouseDownX = chart.mouseDownX, extremes = xAxis.getExtremes(), dataMax = extremes.dataMax,
                    min = extremes.min, max = extremes.max, trimmedRange = void 0, hoverPoints = chart.hoverPoints,
                    ...
                    ordinalPositions = void 0, searchAxisLeft = void 0, lin2val = xAxis.lin2val,
                    val2lin = xAxis.val2lin, searchAxisRight = void 0;
