...
var Axis3DAdditions = /** @class */ (function () {
    ...
    Axis3DAdditions.prototype.fix3dPosition = function (pos, isTitle) {
        ...
        var alpha = deg2rad * chart.options.chart.options3d.alpha, beta = deg2rad * chart.options.chart.options3d.beta,
            ...
            frame = chart.chart3d.frame3d, plotLeft = chart.plotLeft, plotRight = chart.plotWidth + plotLeft,
...
var Axis3D = /** @class */ (function () {
    ...
    Axis3D.wrapGetPlotBandPath = function (proceed) {
        ...
        if (fromPath && toPath) {
            for (var i = 0; i < fromPath.length; i += 2) {
                var fromStartSeg = fromPath[i], fromEndSeg = fromPath[i + 1], toStartSeg = toPath[i],
                    toEndSeg = toPath[i + 1];
                if (fromStartSeg[0] === 'M' &&
                    fromEndSeg[0] === 'L' &&
                    toStartSeg[0] === 'M' &&
    ...
    Axis3D.wrapGetPlotLinePath = function (proceed) {
        var axis = this, axis3D = axis.axis3D, chart = axis.chart,
        ...
        var options3d = chart.options.chart.options3d, d = axis.isZAxis ? chart.plotWidth : options3d.depth,
            frame = chart.chart3d.frame3d, startSegment = path[0], endSegment = path[1];
