...
var ScrollbarAxis = /** @class */ (function () {
    ...
    ScrollbarAxis.compose = function (AxisClass, ScrollbarClass) {
        ...
        addEvent(AxisClass, 'afterInit', function () {
            ...
            if (axis.options &&
                ...
                addEvent(axis.scrollbar, 'changed', function (e) {
                    var _a = getExtremes(axis), axisMin = _a.axisMin, axisMax = _a.axisMax, unitedMin = _a.scrollMin,
                        unitedMax = _a.scrollMax, range = unitedMax - unitedMin, to, from;
        ...
        addEvent(AxisClass, 'afterRender', function () {
            var axis = this, _a = getExtremes(axis), scrollMin = _a.scrollMin, scrollMax = _a.scrollMax,
        ...
        addEvent(AxisClass, 'afterGetOffset', function () {
            var axis = this, opposite = axis.scrollbar && !axis.scrollbar.options.opposite,
                index = axis.horiz ? 2 : opposite ? 3 : 1, scrollbar = axis.scrollbar;
            if (scrollbar) {
