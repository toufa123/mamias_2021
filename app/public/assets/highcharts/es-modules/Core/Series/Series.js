...
var addEvent = U.addEvent, arrayMax = U.arrayMax, arrayMin = U.arrayMin, clamp = U.clamp,
    ...
    objectEach = U.objectEach, pick = U.pick, removeEvent = U.removeEvent, splat = U.splat, syncTimeout = U.syncTimeout;
/* *
 *
 *  Class
 *
...
var Series = /** @class */ (function () {
    ...
    Series.prototype.findPointIndex = function (optionsObject, fromIndex) {
        var id = optionsObject.id, x = optionsObject.x, oldData = this.points, matchingPoint, matchedById, pointIndex,
            matchKey, dataSorting = this.options.dataSorting;
        if (id) {
    ...
    Series.prototype.sortData = function (data) {
        var series = this, options = series.options, dataSorting = options.dataSorting,
            sortKey = dataSorting.sortKey || 'y', sortedData, getPointOptionsObject = function (series, pointOptions) {
    ...
    Series.prototype.getProcessedData = function (forceExtremesFromAll) {
        var series = this,
            ...
            isLog = !!(xAxis && xAxis.logarithmic), throwOnUnsorted = series.requireSorting, min, max;
        if (xAxis) {
    ...
    Series.prototype.generatePoints = function () {
        var series = this, options = series.options, dataOptions = options.data, data = series.data, dataLength,
            ...
            point, points = [], i, groupCropStartIndex = (options.dataGrouping &&
    ...
    Series.prototype.animate = function (init) {
        var series = this, chart = series.chart, animation = animObject(series.options.animation),
    ...
    Series.prototype.markerAttribs = function (point, state) {
        var seriesOptions = this.options, seriesMarkerOptions = seriesOptions.marker, seriesStateOptions,
    ...
    Series.prototype.pointAttribs = function (point, state) {
        var seriesMarkerOptions = this.options.marker, seriesStateOptions, pointOptions = point && point.options,
            pointMarkerOptions = ((pointOptions && pointOptions.marker) || {}), pointStateOptions, color = this.color,
    ...
    Series.prototype.destroy = function (keepEventsForUpdate) {
        var series = this, chart = series.chart, issue134 = /AppleWebKit\/533/.test(win.navigator.userAgent), destroy,
            i, data = series.data || [], point, axis;
        // add event hook
    ...
    Series.prototype.applyZones = function () {
        var series = this, chart = this.chart, renderer = chart.renderer, zones = this.zones, translatedFrom,
            ...
            extremes, reversed, inverted = chart.inverted, horiz, pxRange, pxPosMin, pxPosMax, ignoreZones = false,
            zoneArea, zoneGraph;
        if (zones.length &&
            (graph || area) &&
            axis &&
    ...
    Series.prototype.drawTracker = function () {
        var series = this, options = series.options, trackByArea = options.trackByArea,
            ...
            tracker = series.tracker, i, onMouseOver = function (e) {
                if (chart.hoverSeries !== series) {
                    series.onMouseOver();
                }
            },
    ...
    Series.prototype.update = function (options, redraw) {
        ...
        var series = this, chart = series.chart,
            ...
            plotOptions = chart.options.plotOptions, newType = (options.type ||
            oldOptions.type ||
