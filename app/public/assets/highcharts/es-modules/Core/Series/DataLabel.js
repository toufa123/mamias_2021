...
var defined = U.defined, extend = U.extend, fireEvent = U.fireEvent, isArray = U.isArray, merge = U.merge,
...
(function (DataLabel) {
    ...
    function alignDataLabel(point, dataLabel, options, alignTo, isNew) {
        var series = this, chart = this.chart, inverted = this.isCartesian && chart.inverted,
            ...
            bBox = dataLabel.getBBox(), rotation = options.rotation, align = options.align,
    ...
    function drawDataLabels() {
        var series = this, chart = series.chart, seriesOptions = series.options, points = series.points,
            hasRendered = series.hasRendered || 0, renderer = chart.renderer;
            ...
            points.forEach(function (point) {
                ...
                pointOptions.forEach(function (labelOptions, i) {
                    ...
                    var labelEnabled = (labelOptions.enabled &&
                        ...
                        point.connectors[i] :
                        point.connector;
                    var labelConfig, formatString, labelText, style, rotation, attr,
    ...
    function justifyDataLabel(dataLabel, options, alignAttr, bBox, alignTo, isNew) {
        var chart = this.chart, align = options.align, verticalAlign = options.verticalAlign,
