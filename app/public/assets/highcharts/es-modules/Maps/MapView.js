...
var addEvent = U.addEvent, clamp = U.clamp, fireEvent = U.fireEvent, isNumber = U.isNumber, merge = U.merge,
    pick = U.pick, relativeLength = U.relativeLength;
/**
    ...
    MapView.prototype.fitToBounds = function (bounds, padding, redraw, animation) {
        ...
        if (b) {
            var _a = this.chart, plotWidth = _a.plotWidth, plotHeight = _a.plotHeight,
                pad = pick(padding, bounds ? 0 : this.options.padding), paddingX = relativeLength(pad, plotWidth),
