...
var LinearRegressionIndicator = /** @class */ (function (_super) {
    ...
    LinearRegressionIndicator.prototype.getRegressionLineParameters = function (xData, yData) {
        ...
        var yIndex = this.options.params.index, getSingleYValue = function (yValue, yIndex) {
            ...
            }, 0), xMean = xSum / xData.length, yMean = ySum / yData.length, xError, yError, formulaNumerator = 0,
            formulaDenominator = 0, i, slope;
    ...
    LinearRegressionIndicator.prototype.getValues = function (baseSeries, regressionSeriesParams) {
        var xData = baseSeries.xData, yData = baseSeries.yData, period = regressionSeriesParams.period, lineParameters,
            ...
            indicatorData = {
                ...
                yData: [],
                values: []
            }, endPointX, endPointY, periodXData, periodYData, periodTransformedXData,
