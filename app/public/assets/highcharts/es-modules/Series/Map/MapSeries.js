...
var MapSeries = /** @class */ (function (_super) {
            ...
            (this.points || []).forEach(function (point) {
                if (point.path || point.geometry) {
                    ...
                    if (!point.bounds) {
                        ...
                        var x2_1 = -MAX_VALUE_1, x1_1 = MAX_VALUE_1, y2_1 = -MAX_VALUE_1, y1_1 = MAX_VALUE_1,
                            validBounds_1;
                        ...
                        if (validBounds_1) {
                            ...
                            var propMiddleX = properties && properties['hc-middle-x'],
                                midX = (x1_1 + (x2_1 - x1_1) * pick(point.middleX, isNumber(propMiddleX) ? propMiddleX : 0.5)),
    ...
    MapSeries.prototype.translate = function () {
        var series = this, doFullTranslate = series.doFullTranslate(), mapView = this.chart.mapView,
