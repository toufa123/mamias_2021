...
var addEvent = U.addEvent, extend = U.extend, isArray = U.isArray, isNumber = U.isNumber, isObject = U.isObject,
    isString = U.isString, merge = U.merge;
/* *
 *
 *  Class
 *
...
var VennSeries = /** @class */ (function (_super) {
    ...
    VennSeries.prototype.translate = function () {
        ...
        var _a = VennSeries.layout(relations), mapOfIdToShape = _a.mapOfIdToShape,
        ...
        var field = Object.keys(mapOfIdToShape)
            ...
            scaling = VennSeries.getScale(chart.plotWidth, chart.plotHeight, field), scale = scaling.scale,
