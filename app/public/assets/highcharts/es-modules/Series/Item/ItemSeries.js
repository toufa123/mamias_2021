...
var defined = U.defined, extend = U.extend, fireEvent = U.fireEvent, isNumber = U.isNumber, merge = U.merge,
...
var ItemSeries = /** @class */ (function (_super) {
    ...
    ItemSeries.prototype.drawPoints = function () {
        var series = this, options = this.options, renderer = series.chart.renderer,
            ...
            i = 0, rows = this.getRows(), cols = Math.ceil(this.total / rows), cellWidth = this.chart.plotWidth / cols,
            cellHeight = this.chart.plotHeight / rows, itemSize = this.itemSize || Math.min(cellWidth, cellHeight);
    ...
    ItemSeries.prototype.getSlots = function () {
        var center = this.center, diameter = center[2], innerSize = center[3], row, slots = this.slots, x, y, rowRadius,
            rowLength, colCount, increment, angle, col, itemSize = 0, rowCount,
