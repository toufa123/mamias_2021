...
var addEvent = U.addEvent, arrayMax = U.arrayMax, arrayMin = U.arrayMin, correctFloat = U.correctFloat,
    defined = U.defined, isArray = U.isArray, isNumber = U.isNumber, isString = U.isString, pick = U.pick;
/* *
 *
 *  Composition
 *
...
(function (DataModifyComposition) {
    ...
    function afterProcessData() {
        ...
        if (series.xAxis && // not pies
            ...
            series.dataModify) {
            var processedXData = series.processedXData, processedYData = series.processedYData,
                length_1 = processedYData.length, compareStart = series.options.compareStart === true ? 0 : 1;
